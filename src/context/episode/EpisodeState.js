  ...
  const initialState = {
    episodes: [
      ...
      },
      {
        ...
        season_id: 1,
        episode_id: 3,
        description: 'Molecule is a software platform to accelerate innovation in the pharmaceutical industry. It connects scientists, patients and industry to advance drug development in a collaborative open market.',
      ...
      },
      {
        ...
        season_id: 1,
        episode_id: 4,
        description: 'PocketJam is an app that teaches your child to earn and save their pocket money using math challenges and savings rewards.',
      ...
      },
      {
        ...
        season_id: 1,
        episode_id: 5,
        description: 'UCOOK delivers fresh ingredients directly to your home so you can make delicious meals in exactly the right proportions. We deliver your ingredients for the week every Monday.',
