  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        <a href="https://wildcards.world?ref=podcast" style={{ color: "#afa" }}>
          wildcards.world
        </a>{" "}
        that raises funding for animal conservation.
      </p>
      <br />
      ...
      <div style={gridStyle}>
        <div>
          ...
          <a href={"mailto:jonjonclark@gmail.com"} target="_blank">
        ...
        <div>
          ...
          <a href={"mailto:denhampreen@gmail.com"} target="_blank">
